...

{
	...
	for (var i=0;//igamePiece.length;//i++)// applies features to each puzzle piece 

	{

		gamePiece[i].className = 'puzzlepiece';////setting up the puzzle piece code

		gamePiece[i].style.left = (i%4100)+'px';////calculates the position for puzzle pieces from the left of the screen

		gamePiece[i].style.top = (parseInt(i4)100) + 'px';////calculates the position for puzzle pieces from the top of the screen
